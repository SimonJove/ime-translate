...
| 006 | [`006-lock-hint`](006-lock-hint/plan/README.md) | in progress, 1/2 (smoke pending) | After Enter locks English letters, the preedit shows a hint until the next key |
