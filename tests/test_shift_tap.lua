...
-- Each descriptor keeps its state in its own Context property (session.tap_down)
eq(tap.SHIFT.prop, "shift_down", "Shift's property")
eq(tap.RIGHT_OPTION.prop, "option_down", "Right Option's property")
